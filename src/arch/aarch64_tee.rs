//! Syscalls for the `aarch64` architecture andd kylin teeos
...
syscall_enum! {
    pub enum Sysno {
        ...
        /// TEE syscalls with prefix 500 for OP-TEE compatibility
        tee_scn_return = 500,
        tee_scn_log = 501,
        tee_scn_panic = 502,
        tee_scn_get_property = 503,
        tee_scn_get_property_name_to_index = 504,
        tee_scn_open_ta_session = 505,
        tee_scn_close_ta_session = 506,
        tee_scn_invoke_ta_command = 507,
        tee_scn_check_access_rights = 508,
        tee_scn_get_cancellation_flag = 509,
        tee_scn_unmask_cancellation = 510,
        tee_scn_mask_cancellation = 511,
        tee_scn_wait = 512,
        tee_scn_get_time = 513,
        tee_scn_set_ta_time = 514,
        tee_scn_cryp_state_alloc = 515,
        tee_scn_cryp_state_copy = 516,
        tee_scn_cryp_state_free = 517,
        tee_scn_hash_init = 518,
        tee_scn_hash_update = 519,
        tee_scn_hash_final = 520,
        tee_scn_cipher_init = 521,
        tee_scn_cipher_update = 522,
        tee_scn_cipher_final = 523,
        tee_scn_cryp_obj_get_info = 524,
        tee_scn_cryp_obj_restrict_usage = 525,
        tee_scn_cryp_obj_get_attr = 526,
        tee_scn_cryp_obj_alloc = 527,
        tee_scn_cryp_obj_close = 528,
        tee_scn_cryp_obj_reset = 529,
        tee_scn_cryp_obj_populate = 530,
        tee_scn_cryp_obj_copy = 531,
        tee_scn_cryp_derive_key = 532,
        tee_scn_cryp_random_number_generate = 533,
        tee_scn_authenc_init = 534,
        tee_scn_authenc_update_aad = 535,
        tee_scn_authenc_update_payload = 536,
        tee_scn_authenc_enc_final = 537,
        tee_scn_authenc_dec_final = 538,
        tee_scn_asymm_operate = 539,
        tee_scn_asymm_verify = 540,
        tee_scn_storage_obj_open = 541,
        tee_scn_storage_obj_create = 542,
        tee_scn_storage_obj_del = 543,
        tee_scn_storage_obj_rename = 544,
        tee_scn_storage_enum_alloc = 545,
        tee_scn_storage_enum_free = 546,
        tee_scn_storage_enum_reset = 547,
        tee_scn_storage_enum_start = 548,
        tee_scn_storage_enum_next = 549,
        tee_scn_storage_obj_read = 550,
        tee_scn_storage_obj_write = 551,
        tee_scn_storage_obj_trunc = 552,
        tee_scn_storage_obj_seek = 553,
        tee_scn_cryp_obj_generate_key = 554,
        tee_scn_se_service_open_deprecated = 555,
        tee_scn_se_service_close_deprecated = 556,
        tee_scn_se_service_get_readers_deprecated = 557,
        tee_scn_se_reader_get_prop_deprecated = 558,
        tee_scn_se_reader_get_name_deprecated = 559,
        tee_scn_se_reader_open_session_deprecated = 560,
        tee_scn_se_reader_close_sessions_deprecated = 561,
        tee_scn_se_session_is_closed_deprecated = 562,
        tee_scn_se_session_get_atr_deprecated = 563,
        tee_scn_se_session_open_channel_deprecated = 564,
        tee_scn_se_session_close_deprecated = 565,
        tee_scn_se_channel_select_next_deprecated = 566,
        tee_scn_se_channel_get_select_resp_deprecated = 567,
